...
<template>
  <header class="fixed top-0 w-full clearNav z-50">
    <div class="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
      ...
      <div
        :class="`md:flex flex-grow items-center ${
          navbarOpen ? 'flex' : 'hidden'
        }`"
      >
        <div
          class="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start"
        >
          <a
          ...
          <div class="relative">
            <button
              type="button"
              class="group rounded-md text-gray-300 inline-flex items-center text-base font-medium focus:outline-none pb-8'"
              @mouseover="flyer = true"
            >
              <span class="tr04">Templates</span>
              <svg
                :class="
                  flyer === true
                ...
                <div class="relative grid gap-6 bg-black px-2 py-6 sm:gap-8">
                  ...
                  >
                    <div class="ml-4">
                      ...
                      <p class="mt-1 text-sm text-gray-500">First Template</p>
                    </div>
                  </a>
                  <a
                    href="/"
                  ...
                  >
                    <div class="ml-4">
                      ...
                      <p class="mt-1 text-sm text-gray-500">Second Template</p>
                    </div>
                  </a>
                  <a
                    href="/"
                  ...
                  >
                    <div class="ml-4">
                      ...
                      <p class="mt-1 text-sm text-gray-500">Third Template</p>
                    </div>
                  </a>
                </div>
              </div>
