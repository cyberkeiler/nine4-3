<template>
  <section class="text-gray-600 body-font">
    <div class="max-w-5xl pt-52 pb-24 mx-auto">
      <h1
        class="text-80 text-center font-4 lh-6 ld-04 font-bold text-white mb-6"
      >
        Create your nuxt website fast and easy
      </h1>
      <h2
        class="text-2xl font-4 font-semibold lh-6 ld-04 pb-11 text-gray-700 text-center"
      >
    ...
    <div class="container flex flex-col items-center justify-center mx-auto">
      <img
        class="object-cover object-center w-3/4 mb-10 border shadow-md g327"
    ...
    <br />
    <p
      class="mx-auto text-xl text-center text-gray-300 font-normal leading-relaxed fs521 lg:w-2/3"
    >
      Here is our collection of free to use templates made with nuxt.js &amp;
